/*
 * @Author: Cat9Yuko 
 * @Date: 2020-07-08 10:38:57 
 * @Last Modified by: Cat9Yuko
 * @Last Modified time: 2020-07-08 11:11:06
 */


//  对象的每一个属性都具有有一个描述对象(Descriptor), 用于控制该属性的行为.
...
/* 
    ...
    ES6新增了1个操作Object.assign(), 会忽略enumerable为false的属性, 只复制对象自身的可枚举属性.
    这4个操作之中, 只有for...in会返回继承的属性. 实际上, 引入enumerable的最初目的就是让某些属性可以规避掉for...in操作. 
    比如, 对象原型的toString方法以及数组的length属性, 就通过这种手段而不会被for...in遍历到.
*/
